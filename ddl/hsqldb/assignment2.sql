    ...
    create table A2_ASSIGNMENT_T (
        ASSIGNMENT_ID bigint generated by default as identity (start with 1),
    ...
    create table A2_ASSIGN_ATTACH_T (
        ASSIGN_ATTACH_ID bigint generated by default as identity (start with 1),
    ...
    create table A2_ASSIGN_GROUP_T (
        ASSIGNMENT_GROUP_ID bigint generated by default as identity (start with 1),
        VERSION integer not null,
        ASSIGNMENT_ID bigint not null,
    ...
    create table A2_SUBMISSION_ATTACH_T (
        SUBMISSION_ATTACH_ID bigint generated by default as identity (start with 1),
    ...
    create table A2_SUBMISSION_T (
        SUBMISSION_ID bigint generated by default as identity (start with 1),
        VERSION integer not null,
        ASSIGNMENT_ID bigint not null,
    ...
    create table A2_SUBMISSION_VERSION_T (
        SUBMISSION_VERSION_ID bigint generated by default as identity (start with 1),
        VERSION integer not null,

    ...
    create table A2_ASSIGN_ATTACH_T (
        ASSIGN_ATTACH_ID bigint generated by default as identity,
    ...
    create table A2_ASSIGN_GROUP_T (
        ASSIGNMENT_GROUP_ID bigint generated by default as identity,
        VERSION integer not null,
        ASSIGNMENT_ID bigint not null,
    ...
    create table A2_SUBMISSION_ATTACH_T (
        SUBMISSION_ATTACH_ID bigint generated by default as identity,
    ...
    create table A2_SUBMISSION_VERSION_T (
        SUBMISSION_VERSION_ID bigint generated by default as identity,
        VERSION integer not null,

...
<link media="all" href="../css/tool.css" type="text/css" rel="stylesheet" />
...
-->
    ...
    <script type="text/javascript" language="JavaScript">
        var sakai = sakai || {};
        sakai.curPlacement = 'someplacement';
        sakai.curContext = 'somecontext';
    </script>
...
<div style="margin: 0; padding: 5px; border-top: solid 2px #cccccc;">
    ...
    <table style="display: none; border-collapse: collapse" id="asnn-list">
      <thead>
        <tr>
          ...
          <th class="asnn-decorated-cell">
            ...
            <img class="addimage" src="../images/add.png" />
      ...
      <tbody id="asnn-list-body">
        <tr class="row">
          <td style="width: 40px"><img style="display:none" alt="Move Assignment" src="../images/4Arrows.png" class="movehandle" /></td>
          <td class="asnn-decorated-cell"><p style="padding:0;margin:0;">
            <span style="display:none" class="asnnid">1</span>
            <span class="asnntitle">Audio Scriptwriting</span>
            <img class="attachments" src="../images/attach.png" />
